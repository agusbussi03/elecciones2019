...
$app->get('/logo_candidato_senador/{nombre}', function ($nombre) use ($app) {
    $candidato = $app['db']->fetchAssoc("SELECT * FROM cargo_departamental c left join candidato can on c.candidato_id=can.id ,"
